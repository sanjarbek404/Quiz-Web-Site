...
import { createUserWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, setPersistence, browserLocalPersistence } from 'firebase/auth';
...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const role = email === 'sanjarbekotabekov010@gmail.com' ? 'admin' : 'user';
      ...
      if (err.code === 'auth/operation-not-allowed') {
        ...
        setError("Parol juda kuchsiz. Kamida 6 ta belgidan iborat bo'lishi kerak.");
      } else if (err.code === 'auth/invalid-credential') {
        setError("Ma'lumotlar noto'g'ri. Iltimos, qaytadan urinib ko'ring.");
      } else {
